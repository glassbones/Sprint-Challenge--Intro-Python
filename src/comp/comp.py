...
rang = "C D E F G"
print("Starts between C and G, inclusive:") #   have to split rang by spaces into list then convert to tuple   # .startswith  is picky
c = [human.name for human in humans if human.name.startswith( tuple(rang.split(" ")) ) ]
print(c)
...
h = [sqr(human.age) for human in humans ]
print(h)
